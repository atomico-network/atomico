...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x18114A; // atom
        ...
        const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX = 0; // 187000;

        const size_t ZAWY_DIFFICULTY_V2 = 0;

        const uint8_t ZAWY_DIFFICULTY_DIFFICULTY_BLOCK_VERSION = 3;

        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX = 1; // 620000;

        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V2 = 700000;

        const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3 = 800000;

        const unsigned EMISSION_SPEED_FACTOR = 9 // 25;
        ...
        const uint64_t MINIMUM_FEE = UINT64_C(10000); // 10

        /* This section defines our minimum and maximum mixin counts required for transactions */
        const uint64_t MINIMUM_MIXIN_V1 = 0;

        const uint64_t MAXIMUM_MIXIN_V1 = 3; // 100;

        const uint64_t MINIMUM_MIXIN_V2 = 3; // 7;

        const uint64_t MAXIMUM_MIXIN_V2 = 3; // 7;
        ...
        const uint32_t MIXIN_LIMITS_V1_HEIGHT = 0; // 440000;

        const uint32_t MIXIN_LIMITS_V2_HEIGHT = 1; // 620000;

        const uint32_t MIXIN_LIMITS_V3_HEIGHT = 2; // 800000;
    ...
    const char CRYPTONOTE_NAME[] = "Atomico";
